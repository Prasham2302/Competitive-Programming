...
//            int n = scan.nextInt();
//            int[] x = new int[n];
//            HashMap<Double,Double> map = new HashMap<>();//y,x
//            Point2D[] points = new Point2D[n+2];
//            for(int i = 0;i<n;i++){
//                x[i] = scan.nextInt();
//                map.put((double)i+1,(double)x[i]);
//                points[i] = new Point2D(i+1,x[i]);
//            }
////            System.out.println(map.keySet());
//            points[n] = new Point2D(1.0,0.0);
//            points[n+1] = new Point2D((double)n,0.0);
...
//                int curr = (int) Math.abs(points1.get(j).x() - points1.get(j+1).x());
...
//////                System.out.println(points[i].x() +" "+points[i+1].x());
////                if(map.get(points[i].x()) == points[i].y() && map.get(points[i+1].x()) == points[i+1].y()){
////
////                    double curr = Math.abs(points[i].x() - points[i+1].x());
